          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center lg:text-start leading-tight md:leading-snug lg:leading-normal text-black">
                Publikasi Jurnal Tanpa <br />
                Ribet dan <span className="text-blue-600">Lebih Terarah</span>
              </h1>
            </div>
            ...
            <p className="text-gray-600 max-w-xl leading-relaxed text-center lg:text-start">
              ...
              atau EBSCO dengan lebih percaya diri? Kami mendampingi proses dari
              A–Z: pemilihan jurnal, perapihan artikel, editing & proofreading,
              hingga pendampingan revisi bersama reviewer.
            </p>
