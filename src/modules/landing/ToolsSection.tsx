          ...
          <div className="max-w-5xl px-4 xl:px-0 py-10 mx-auto">
            <div className="border border-line-2 rounded-xl">
              <div className="p-4 lg:p-8 bg-linear-to-bl from-layer via-background to-background-1 rounded-xl">
                <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-10 lg:gap-y-20 gap-x-12">
                  {/* Stats */}
                  <div className="relative text-center first:before:hidden before:hidden sm:before:block before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 sm:before:h-20 sm:before:border-s sm:before:border-line-2 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                    <div className="flex justify-center items-center -space-x-5">
                      <Image
                        ...
                        height={500}
                        priority
                        className="w-40 lg:w-100 lg:h-auto h-auto"
                      />
                    </div>
                  </div>
                  {/* End Stats */}
